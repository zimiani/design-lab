...
export default function ScreenPartsDetail() {
  ...
  if (parts.length === 0) {
    return (
      <div className="flex-1 flex items-center justify-center p-[var(--token-spacing-8)]">
  ...
  return (
    <div className="flex-1 overflow-y-auto p-[var(--token-spacing-8)]">
      <div className="max-w-[720px]">
        <h1 className="text-[length:var(--token-font-size-heading-lg)] leading-[var(--token-line-height-heading-lg)] font-semibold text-shell-text mb-[var(--token-spacing-2)]">
          Screen Parts
        </h1>
        <p className="text-[length:var(--token-font-size-body-md)] leading-[var(--token-line-height-body-md)] text-shell-text-secondary mb-[var(--token-spacing-8)]">
        ...
        <div className="flex flex-col gap-[var(--token-spacing-8)]">
          {Array.from(grouped.entries()).map(([flow, screens]) => (
            <div key={flow}>
              <h2 className="text-[length:var(--token-font-size-heading-sm)] leading-[var(--token-line-height-heading-sm)] font-semibold text-shell-text mb-[var(--token-spacing-4)] capitalize">
                {flow}
              </h2>
              ...
              <div className="flex flex-col gap-[var(--token-spacing-4)]">
                {Array.from(screens.entries()).map(([screen, screenParts]) => (
                  <div key={screen} className="border border-shell-border rounded-[var(--token-radius-md)] overflow-hidden">
                    <div className="bg-shell-surface px-[var(--token-spacing-4)] py-[var(--token-spacing-3)] border-b border-shell-border">
                    ...
                    <div className="divide-y divide-shell-border">
                      {screenParts.map((part) => (
                        <div
                          key={part.name}
                          className="px-[var(--token-spacing-4)] py-[var(--token-spacing-3)] flex items-center justify-between"
                        >
                          <code className="text-[length:var(--token-font-size-body-sm)] text-shell-text">
                            {part.name}
                          </code>
                          <span className="text-[length:var(--token-font-size-caption)] leading-[var(--token-line-height-caption)] text-shell-text-tertiary bg-shell-surface px-[var(--token-spacing-2)] py-[var(--token-spacing-1)] rounded-[var(--token-radius-sm)]">
