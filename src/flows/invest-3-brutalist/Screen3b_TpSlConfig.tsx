/**
 * Screen3b_TpSlConfig — Buy TP/SL configuration screen (Neo-Brutalist).
 * Flat containers, hard borders, black CTA pill.
...
import {
  getAsset, getAssetColor, isVolatile,
  ...
  return (
    <div className="relative flex flex-col h-full overflow-hidden" style={{ background: BG }}>
      ...
      <div className="relative flex-1 overflow-y-auto" style={{ paddingTop: `calc(${SAFE_TOP} + 8px)` }}>
        ...
        {/* Chart with PriceLine overlays — flat container with hard border */}
        <motion.div className="relative px-4 mb-6" {...fadeUp(0.1)}>
          ...
          >
            ...
            {/* TP/SL overlay lines */}
            <div className="absolute inset-0 pointer-events-none" style={{ padding: '4px 0' }}>
              {tpEnabled && (
                <PriceLine
                  price={tpPrice}
                  label="TP"
        ...
        {/* Summary card — flat, hard borders */}
        <AnimatePresence>
        {hasConfig && (
          <motion.div
            className="px-4 mb-6"
          ...
          >
            ...
            >
              ...
              {tpEnabled && (
                <div
                  className="flex items-center justify-between py-2.5"
                  style={{ borderBottom: slEnabled ? `1px solid ${BORDER_LIGHT}` : 'none' }}
                >
                  <div className="flex items-center gap-2">
                    <div style={{ width: 6, height: 6, background: GREEN }} />
              ...
              {slEnabled && (
                <div className="flex items-center justify-between py-2.5">
                  <div className="flex items-center gap-2">
                    <div style={{ width: 6, height: 6, background: RED }} />
      ...
      >
        <motion.button
          ...
          style={{
            height: 52,
            background: hasConfig ? '#000000' : BG_CARD,
            border: hasConfig ? 'none' : `1px solid ${BORDER_LIGHT}`,
            fontSize: 16,
            fontWeight: 700,
            color: hasConfig ? '#FFFFFF' : TEXT_MUTED,
