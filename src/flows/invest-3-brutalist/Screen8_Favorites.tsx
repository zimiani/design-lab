/**
 * Favorites — neo-brutalist list of favorited assets with inline sparklines.
 * Empty state when no favorites. Clean list with 1px dividers, no card backgrounds.
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: BG }}>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Asset rows — clean list with 1px dividers, no card backgrounds */}
