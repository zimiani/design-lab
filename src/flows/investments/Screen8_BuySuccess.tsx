...
export default function Screen8_BuySuccess({ onBack, onElementTap }: FlowScreenProps) {
  return (
    <FeedbackLayout onClose={onBack}>
      <Stack gap="sm">
        <Text variant="display">Compra confirmada</Text>
        <Text variant="body-md" color="content-secondary">
          Seu investimento já está no seu portfólio.
        </Text>
      </Stack>

      <Stack gap="none">
        <GroupHeader text="Dados da compra" />
        <DataList
          data={[
