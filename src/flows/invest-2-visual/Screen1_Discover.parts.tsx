  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Sparkline */}
        <Sparkline data={sparkline} color={color} width={50} height={20} />
...
export function FeaturedCard({ asset, color, sparkline, onPress }: FeaturedCardProps) {
  const volatile = isVolatile(asset)
  const change = asset.change24h ?? 0
  const isPositive = change >= 0
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        color: active ? '#0a0a0f' : TEXT_TERTIARY,
        fontSize: 13,
