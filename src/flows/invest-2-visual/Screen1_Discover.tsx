...
import { AssetRow, FeaturedCard, CategoryPill } from './Screen1_Discover.parts'
import { FavChip } from './Screen0_Dashboard.parts'
  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border-none cursor-pointer"
      ...
      <AnimatePresence>
        ...
        <>
          ...
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="absolute right-0 top-full mt-1 z-40 rounded-xl overflow-hidden min-w-[140px]"
            style={{
          ...
          >
            {(Object.keys(SORT_LABELS) as SortOption[]).map(opt => (
              <motion.button
                ...
                style={{
                  background: opt === value ? 'rgba(255,255,255,0.06)' : 'transparent',
