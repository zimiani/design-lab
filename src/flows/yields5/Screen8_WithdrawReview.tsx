...
export default function Screen8_WithdrawReview({ onNext, onBack }: FlowScreenProps) {
  return (
    <BaseLayout>
      ...
      <Stack gap="default">
        ...
        <Alert variant="neutral" title="Informações fiscais" description={TAX_DESCRIPTION} />
      </Stack>
      <StickyFooter>
        <Button fullWidth onPress={onNext}>Confirmar resgate</Button>
      </StickyFooter>
    </BaseLayout>
  )
}
