...
import { RiArrowLeftLine, RiHeartLine } from '@remixicon/react'
import type { FlowScreenProps } from '@/pages/simulator/flowRegistry'
import {
  getFavoriteAssets, getSparkline, isVolatile,
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <motion.div variants={listContainer} initial="hidden" animate="visible" className="flex flex-col">
          {favorites.map((asset, i) => {
            const pal = getAssetPalette(asset.ticker)
            ...
            return (
              ...
              >
                {/* Icon */}
                <TokenLogoCircle ticker={asset.ticker} fallbackUrl={asset.icon} size={28} color={pal.iconBg} className="flex-shrink-0" />
                ...
                {/* Sparkline */}
                <Sparkline data={sparkline} color={pal.accent} width={60} height={24} index={i} />
