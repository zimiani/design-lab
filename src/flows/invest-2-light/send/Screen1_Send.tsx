      ...
      <div className="flex-1 overflow-y-auto px-5">
        ...
        <motion.div {...stagger(0, 0)} className="mb-5">
          ...
          >
            ...
            <style>{`
              input::placeholder { color: rgba(0,0,0,0.12) !important; }
            `}</style>
          </div>
        </motion.div>
            ...
            {dropdownOpen && (
              ...
              >
                {NETWORKS.map(network => (
                  ...
                  >
                    <NetworkLogo networkId={network.id} fallbackUrl={network.icon} size={20} color={NETWORK_COLORS[network.id]} className="rounded-full" />
