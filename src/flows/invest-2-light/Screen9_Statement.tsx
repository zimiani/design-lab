  ...
  return (
    <div className="relative flex-1 min-w-0">
      <motion.button
        ...
        style={{
          background: BG_CARD,
          border: `1px solid ${open ? 'rgba(0,0,0,0.08)' : BORDER}`,
        }}
      >
          ...
          >
            {options.map(option => (
              <motion.button
                ...
                style={{
                  background: value === option ? 'rgba(0,0,0,0.05)' : 'transparent',
            ...
            {filtered.map((tx, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Icon */}
                  <TokenLogoCircle ticker={tx.assetTicker} fallbackUrl={tx.assetIcon} size={24} color={getAssetPalette(tx.assetTicker).iconBg} className="flex-shrink-0" />
