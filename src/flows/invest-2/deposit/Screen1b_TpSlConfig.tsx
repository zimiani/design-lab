/**
 * Investment Deposit — TP/SL Config (Buy)
 * Allows configuring Take Profit and Stop Loss price levels before placing a buy order.
 */
...
import { PriceLevelLine, PriceInputSheet, TpSlSummaryCard } from './Screen1b_TpSlConfig.parts'
...
export default function Screen1b_TpSlConfig({ onNext, onBack, onElementTap }: FlowScreenProps) {
  ...
  return (
    <BaseLayout>
      <Header title="Configurar TP/SL" onBack={onBack} />
