...
import { MOCK_BALANCE, USD_ICON, WITHDRAW_QUICK_PICKS, rawDigitsFromAmount, TAX_DESCRIPTION } from '../shared/data'

export default function Screen1_WithdrawAmount({ onNext, onBack }: FlowScreenProps) {
    ...
    <BaseLayout>
      ...
      <Stack gap="default">
        ...
        <Stack direction="row" gap="sm">
          ...
          <Button variant="primary" inverse size="sm" onPress={() => setValue('')}>
            Outro
          </Button>
        </Stack>
